      ...
      <div class="container">
        <div class="ps-content">
          ...
          <p>
            ...
            есть полный комплект фото. За 11 лет работы компания реализовала более 250 коммерческих объектов, однако не все из них были задокументированы в формате, пригодном для публикации. <span class="blue">В первые годы работы мы умели строить, но не умели фотографировать 😅</span>. По запросу пришлём примеры работ именно по вашему
            направлению.
          </p>
        </div>
      </div>
