...
const premises = [
  ...
  { slug: 'kliniki', title: 'Медицинские помещения', subtitle: 'клиники, кабинеты, лаборатории', category: 'other', price: 'от 18 000 ₽ за м²', priceExample: 'за 100 м² ~1.8–2.8 млн ₽', description: 'Отделка по проекту или ТЗ: бесшовные покрытия, стены под дезинфекцию, специфические материалы. Проверяем основание под спец. полы, герметичность мокрых зон. Работаем с медицинскими материалами (линолеум, нержавейка, спец. смеси и прочие).', image: 'main/remont-pomesheniy/medicina.webp', isReady: true },
