<template>
  <div class="operations-history">
    ...
    <button @click="showExpenseModal = true">Добавить расход</button>
    ...
    <button @click="showIncomeModal = true">Добавить приход</button>
          ...
          >
            <div v-if="expense" class="operation-content">
              ...
              <div class="operation-details">
                <div class="comment">{{ expense.expenseType || 'Без комментария' }}</div>
