<template>
  <div class="intro">
    <div class="content">
      <div class="text">
        <h4>О нас</h4>
        <h3>Почему выбирают <span>Глав Профи?</span></h3>
        <p>
          Работаем с <b>2008</b> года и за это время завоевали доверие сотен
          клиентов. Нас рекомендуют, а многие работают с нами не первый год,
          зная, что мы предлагаем надежное качество и четкое выполнение сроков.
        </p>
        <NuxtLink to="/about">
          <UIButtonsMainButton text="Подробнее" />
        </NuxtLink>
      </div>
      <img
        class="image"
        src="/main/about.png"
        alt="Изображение наброска здания"
      />
    </div>
    <div class="exp">
      <div class="box">
        <div class="ico"><Icon name="fluent:city-24-regular" class="icon" /></div>
        <p>Работаем с 2008 года<br />в Рязани</p>
      </div>
      <div class="box">
