  ...
  data() {
    return {
      tabs: [
        ...
        //   key: 'services',
        //   label: 'Услуги',
        //   categories: ['Все услуги', 'Отделка', 'Электромонтаж', 'Сантехника'],
        //   images: [
        //     { src: '/main/3.jpg', category: 'Отделка' },
        //     { src: '/main/2.jpg', category: 'Электромонтаж' },
        //     { src: '/main/1.jpg', category: 'Отделка' },
        //     { src: '/main/3.jpg', category: 'Сантехника' },
        //   ],
        // },
      ],
    };
